...
public:
    ...
    /** Persist currently supported settings through SettingsManager. */
    Q_INVOKABLE void saveSettings();
    /** Forward a confirmed reboot request to SettingsManager. */
    Q_INVOKABLE void reboot();
    /** Forward a confirmed shutdown request to SettingsManager. */
    Q_INVOKABLE void shutdown();
    /** Append a runtime log entry shown by the settings page. */
...
private:
    ...
    void connectSignals();
    void applySnapshot(const SystemMetricsSnapshot& snapshot);
    void checkThresholds();

private:
    SystemMetricsService* m_metricsService;
