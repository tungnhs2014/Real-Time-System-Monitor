...
/*
 * ILI9341 framebuffer display driver over SPI.
 *
 * The driver exposes a small fbdev surface for the 320x240 RGB565 panel and
 * flushes changed framebuffer pages through deferred I/O.
 *
 * Author: TungNHS
 */
...
/* Convert RGB565 to BGR565 for the panel byte order. */
...
static int ili9341_probe(struct spi_device *spi)
{
	...
	dev_info(&spi->dev, "ILI9341 framebuffer driver loaded (rotation=%d, fps=%d)\n",
		 par->rotation, FPS);
